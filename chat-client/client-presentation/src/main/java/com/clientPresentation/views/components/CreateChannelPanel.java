    ...
    private void initComponents() {
        ...
        createBtn.addActionListener(a -> {
            ...
            if (channelName.isEmpty()) {
                JOptionPane.showMessageDialog(this, "El nombre del canal no puede estar vacío", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            new SwingWorker<Integer, Void>() {
                @Override protected Integer doInBackground() { 
                    return createChannelCommand.execute(new CreateChannelClientCommand.Request(channelName, (ChannelVisibility) visibility.getSelectedItem())); 
                }
