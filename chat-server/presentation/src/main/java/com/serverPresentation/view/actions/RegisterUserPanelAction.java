package com.serverPresentation.view.actions;
...
public class RegisterUserPanelAction extends JPanel {
    ...
    public RegisterUserPanelAction(UserController userController) {
    ...
    private void initComponents() {
        ...
        // Borde exterior para crear el efecto de contenedor como en la imagen
        setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createEmptyBorder(20, 20, 20, 20), // Margen exterior
                BorderFactory.createLineBorder(new Color(210, 210, 210)) // Línea del contenedor
        ));
        ...
        Border roundedBorder = BorderFactory.createCompoundBorder(
                new RoundBorder(10, new Color(200, 200, 200)), // Borde redondeado
                BorderFactory.createEmptyBorder(5, 10, 5, 10)    // Padding interno
        );

        // --- Fields Initialization and Styling ---
